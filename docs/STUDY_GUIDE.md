...
*   **Model Selection for Free Tier Limits:** Frontier preview models (e.g. `gemini-3.6-flash`) enforce strict Free Tier daily caps (e.g. 20 requests/day). Standard production models like `gemini-3.6-flash` or `gemini-3.6-flash` provide higher operational limits (15 RPM / 1,500 RPD), making them ideal for high-throughput testing and development.
