...
async def test_full_rag_integration_pipeline():
    async with AsyncClient(transport=ASGITransport(app=app), base_url="http://test") as client:
        ...
        try:
            ...
            assert any(x in answer_lower for x in ["not find", "couldn't find", "don't have enough", "not mentioned", "not provided", "no information", "cannot answer", "cover", "sufficient information in the loaded documents"]), f"Fabricated answer detected: {ooc_data['answer']}"
